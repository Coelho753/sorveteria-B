...
const env = {
  ...
  corsOrigin: readEnv(['CORS_ORIGIN'], 'https://aylasorvetes.com.br'),
  corsAllowlist: parseOrigins(readEnv(['CORS_ALLOWLIST'], readEnv(['CORS_ORIGIN'], 'https://aylasorvetes.com.br'))),
